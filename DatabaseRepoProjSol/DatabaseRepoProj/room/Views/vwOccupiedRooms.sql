CREATE view [room].[vwOccupiedRooms]
as
...
where b.date_id between CONVERT (date,convert(char(8),fromdateid)) and CONVERT (date,convert(char(8),ToDateID))
and date_id>dateadd(DD,-7,getdate()) and a.RoomStatusID not in (1,8)