CREATE PROCEDURE [account].[spGetLaundryPaymentDetails] --551,52
(
    @TransactionID int,
	@DrawerID int=0,
...
BEGIN
	...
	tm.TransactionMode,
	c.currencycode,
	--CONCAT(att.TransactionType, ' ', c.CurrencySymbol, ' ', FORMAT(atm.ActualAmount, 'N2'), ' Laundry Payment') AS Description,
	...
	tm.TransactionMode,
	c.currencycode,
	--CONCAT(att.TransactionType, ' ', c.CurrencySymbol, ' ', FORMAT(atm.Amount, 'N2'),'Laundry Payment') AS Description,
	atz.Remarks as Description,
