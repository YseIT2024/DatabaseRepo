CREATE PROCEDURE [account].[spPickUpAndDropPaymentAccountTransaction]
(
					...
					BEGIN TRANSACTION	
						...
						IF(@TransactionModeID = 1)--Cash Transaction Mode
							BEGIN
								...
								@TransactionModeID, @UserID, GETDATE(), @AccountingDateID, @DrawerID,@ContactID,@pickupdropid,@GuestCompanyId,@GuestCompanyTypeId)
								...
								--set CashPaid=@USDAmount where OrderId=@pickupdropid
