...
CREATE PROCEDURE [reservation].[spGetCheckedOutReservationToChangeRate]
(
	@FolioNumber int,
	@LocationID int
)
...
BEGIN
	...
	WHERE r.FolioNumber = @FolioNumber AND r.LocationID = @LocationID AND ReservationStatusID = 4
