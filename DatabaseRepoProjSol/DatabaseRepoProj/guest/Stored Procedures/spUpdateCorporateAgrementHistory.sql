CREATE proc [guest].[spUpdateCorporateAgrementHistory] --'2023-04-07','2023-04-14',382
...
update  [company].[RateContracts] set ContractFrom=@ContractFrom , ContractTo=@ContractTo 
